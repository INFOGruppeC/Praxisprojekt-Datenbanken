...
public class GUI extends JFrame {
  ...
  public GUI() { 
    ...
    ausgabenWechsler = new javax.swing.Timer( 500, new ActionListener() {
        public void actionPerformed( ActionEvent e ) {
          ...
          if (quizspiel.gibBearbeitungenSpiel()!=0) textfeldWertung.setText(quizspiel.gibKorrekteBearbeitungenSpiel()*100 / quizspiel.gibBearbeitungenSpiel() + " %");
          textfeldWertungEinzeln.setText(quizspiel.gibKorrekteBearbeitungenSpiel() +" / "+quizspiel.gibBearbeitungenSpiel());          

          if (quizspiel.gibBearbeitungenGesamt()!=0) textfeldGesamtwertung.setText(quizspiel.gibKorrekteBearbeitungenGesamt()*100 / quizspiel.gibBearbeitungenGesamt() + " %");
  ...
  public void knopfAntwortA_ActionPerformed(ActionEvent evt) {
    ...
    if (aktuelleAufgabe.korrektBeantwortet()){
      ...
      if (knopfAntwortB.getText() == aktuelleAufgabe.gibKorrekteAntwort()) knopfAntwortB.setBackground(Color.GREEN);
      if (knopfAntwortC.getText() == aktuelleAufgabe.gibKorrekteAntwort()) knopfAntwortC.setBackground(Color.GREEN);
      if (knopfAntwortD.getText() == aktuelleAufgabe.gibKorrekteAntwort()) knopfAntwortD.setBackground(Color.GREEN); 
    }    
  ...
  public void knopfAntwortB_ActionPerformed(ActionEvent evt) {
    ...
    if (aktuelleAufgabe.korrektBeantwortet()){
      ...
      if (knopfAntwortA.getText() == aktuelleAufgabe.gibKorrekteAntwort()) knopfAntwortA.setBackground(Color.GREEN);
      if (knopfAntwortC.getText() == aktuelleAufgabe.gibKorrekteAntwort()) knopfAntwortC.setBackground(Color.GREEN);
      if (knopfAntwortD.getText() == aktuelleAufgabe.gibKorrekteAntwort()) knopfAntwortD.setBackground(Color.GREEN); 
    }    
